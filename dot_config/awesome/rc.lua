...
--awful.util.tagnames = { "www", "edit", "term", "other", "music" }
-- Use this : https://fontawesome.com/cheatsheet
--awful.util.tagnames = { "", "", "", "", "" }
awful.util.tagnames = { "  ", "  ", "  ", "  ", "Other" }
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "F9", function () awful.util.spawn( "xfce4-settings-manager" ) end,
        {description = "XFCE Settings" , group = "function keys" }),
    ...
    -- super + ...
    awful.key({ modkey }, ".", function () awful.util.spawn( "rofimoji --action type copy" ) end,
        {description = "rofimoji" , group = "super" }),
    awful.key({ modkey }, "`", function () awful.util.spawn( "/home/josh/.config/rofi/launchers/launcher.sh" ) end,
    ...
    awful.key({ modkey }, "v", function () awful.util.spawn( "copyq show" ) end,
        {description = "copyq open", group = "super"}),
